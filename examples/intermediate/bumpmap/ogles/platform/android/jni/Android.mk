...
ASSETDIR := $(PVRSDKDIR)/examples/intermediate/bumpmap/ogles/platform/android/assets
...
# Module ogles_bumpmap
include $(CLEAR_VARS)

LOCAL_MODULE    := ogles_bumpmap

### Add all source file names to be included in lib separated by a whitespace
LOCAL_SRC_FILES  := ogles_bumpmap.cpp
