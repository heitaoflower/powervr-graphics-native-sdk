...
ASSETDIR := $(PVRSDKDIR)/examples/intermediate/bumpmap/vulkan/platform/android/assets
...
# Module vulkan_bumpmap
include $(CLEAR_VARS)

LOCAL_MODULE    := vulkan_bumpmap

### Add all source file names to be included in lib separated by a whitespace
LOCAL_SRC_FILES  := vulkan_bumpmap.cpp
