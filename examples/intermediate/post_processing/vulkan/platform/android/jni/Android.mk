...
ASSETDIR := $(PVRSDKDIR)/examples/intermediate/post_processing/vulkan/platform/Android/assets
...
# Module vulkan_post_processing
include $(CLEAR_VARS)

LOCAL_MODULE    := vulkan_post_processing

### Add all source file names to be included in lib separated by a whitespace
LOCAL_SRC_FILES  := vulkan_post_processing.cpp
