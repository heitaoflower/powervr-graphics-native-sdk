...
ASSETDIR := $(PVRSDKDIR)/examples/intermediate/post_processing/ogles/platform/android/assets
...
# Module ogles_post_processing
include $(CLEAR_VARS)

LOCAL_MODULE    := ogles_post_processing

### Add all source file names to be included in lib separated by a whitespace
LOCAL_SRC_FILES  := ogles_post_processing.cpp
