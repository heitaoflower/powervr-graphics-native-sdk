...
ASSETDIR := $(PVRSDKDIR)/examples/intermediate/multi_sampling/vulkan/platform/android/assets
...
# Module vulkan_multi_sampling
include $(CLEAR_VARS)

LOCAL_MODULE    := vulkan_multi_sampling

### Add all source file names to be included in lib separated by a whitespace
LOCAL_SRC_FILES  := vulkan_multi_sampling.cpp
