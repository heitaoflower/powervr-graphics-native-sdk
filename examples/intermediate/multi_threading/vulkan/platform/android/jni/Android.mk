...
ASSETDIR := $(PVRSDKDIR)/examples/intermediate/multi_threading/vulkan/platform/android/assets
...
# Module vulkan_multi_threading
include $(CLEAR_VARS)

LOCAL_MODULE    := vulkan_multi_threading

### Add all source file names to be included in lib separated by a whitespace
LOCAL_SRC_FILES  := vulkan_multi_threading.cpp
