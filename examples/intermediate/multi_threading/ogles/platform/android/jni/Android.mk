...
ASSETDIR := $(PVRSDKDIR)/examples/intermediate/multi_threading/ogles/platform/android/assets
...
# Module ogles_multi_threading
include $(CLEAR_VARS)

LOCAL_MODULE    := ogles_multi_threading

### Add all source file names to be included in lib separated by a whitespace
LOCAL_SRC_FILES  := ogles_multi_threading.cpp
