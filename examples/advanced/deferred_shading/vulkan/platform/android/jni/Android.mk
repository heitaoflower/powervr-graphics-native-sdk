...
ASSETDIR := $(PVRSDKDIR)/examples/advanced/deferred_shading/vulkan/platform/android/assets
...
# Module vulkan_deferred_shading
include $(CLEAR_VARS)

LOCAL_MODULE    := vulkan_deferred_shading

### Add all source file names to be included in lib separated by a whitespace
LOCAL_SRC_FILES  := vulkan_deferred_shading.cpp
