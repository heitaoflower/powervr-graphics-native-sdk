...
ASSETDIR := $(PVRSDKDIR)/examples/advanced/deferred_shading/ogles/platform/android/assets
...
# Module ogles_deferred_shading
include $(CLEAR_VARS)

LOCAL_MODULE    := ogles_deferred_shading

### Add all source file names to be included in lib separated by a whitespace
LOCAL_SRC_FILES  := ogles_deferred_shading.cpp
