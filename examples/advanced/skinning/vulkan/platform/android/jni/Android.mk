...
ASSETDIR := $(PVRSDKDIR)/examples/advanced/skinning/vulkan/platform/android/assets
...
# Module vulkan_skinning
include $(CLEAR_VARS)

LOCAL_MODULE    := vulkan_skinning

### Add all source file names to be included in lib separated by a whitespace
LOCAL_SRC_FILES  := vulkan_skinning.cpp
