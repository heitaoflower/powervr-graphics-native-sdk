...
ASSETDIR := $(PVRSDKDIR)/examples/advanced/skinning/ogles/platform/android/assets
...
# Module ogles_skinning
include $(CLEAR_VARS)

LOCAL_MODULE    := ogles_skinning

### Add all source file names to be included in lib separated by a whitespace
LOCAL_SRC_FILES  := ogles_skinning.cpp
