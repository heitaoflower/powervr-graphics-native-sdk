...
ASSETDIR := $(PVRSDKDIR)/examples/advanced/gnome_horde/vulkan/platform/android/assets
...
# Module vulkan_gnome_horde
include $(CLEAR_VARS)

LOCAL_MODULE    := vulkan_gnome_horde

### Add all source file names to be included in lib separated by a whitespace
LOCAL_SRC_FILES  := vulkan_gnome_horde.cpp
