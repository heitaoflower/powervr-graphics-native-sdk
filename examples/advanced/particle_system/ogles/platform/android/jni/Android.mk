...
ASSETDIR := $(PVRSDKDIR)/examples/advanced/particle_system/ogles/platform/android/assets
...
# Module ogles_particle_system
include $(CLEAR_VARS)

LOCAL_MODULE    := ogles_particle_system

### Add all source file names to be included in lib separated by a whitespace
LOCAL_SRC_FILES  := ogles_particle_system.cpp \
