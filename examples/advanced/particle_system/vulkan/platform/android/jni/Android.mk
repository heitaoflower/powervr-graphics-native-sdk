...
ASSETDIR := $(PVRSDKDIR)/examples/advanced/particle_system/vulkan/platform/android/assets
...
# Module vulkan_particle_system
include $(CLEAR_VARS)

LOCAL_MODULE    := vulkan_particle_system

### Add all source file names to be included in lib separated by a whitespace
LOCAL_SRC_FILES  := vulkan_particle_system.cpp \
                    particle_system_gpu.cpp
