...
ASSETDIR := $(PVRSDKDIR)/examples/advanced/example_ui/vulkan/platform/android/assets
...
# Module vulkan_example_ui
include $(CLEAR_VARS)

LOCAL_MODULE    := vulkan_example_ui

### Add all source file names to be included in lib separated by a whitespace
LOCAL_SRC_FILES  := vulkan_example_ui.cpp
