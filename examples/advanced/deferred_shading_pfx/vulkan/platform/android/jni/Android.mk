...
ASSETDIR := $(PVRSDKDIR)/examples/advanced/deferred_shading_pfx/vulkan/platform/android/assets
...
# Module vulkan_deferred_shading_pfx
include $(CLEAR_VARS)

LOCAL_MODULE    := vulkan_deferred_shading_pfx

### Add all source file names to be included in lib separated by a whitespace
LOCAL_SRC_FILES  := vulkan_deferred_shading_pfx.cpp
