...
ASSETDIR := $(PVRSDKDIR)/examples/beginner/04_introducing_pvr_api/vulkan/platform/android/assets
...
# Module vulkan_introducing_pvr_api
include $(CLEAR_VARS)

LOCAL_MODULE    := vulkan_introducing_pvr_api

### Add all source file names to be included in lib separated by a whitespace
LOCAL_SRC_FILES  := vulkan_introducing_pvr_api.cpp
