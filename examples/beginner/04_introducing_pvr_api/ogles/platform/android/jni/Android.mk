...
ASSETDIR := $(PVRSDKDIR)/examples/beginner/04_introducing_pvr_api/ogles/platform/android/assets
...
# Module ogles_introducing_pvr_api
include $(CLEAR_VARS)

LOCAL_MODULE    := ogles_introducing_pvr_api

### Add all source file names to be included in lib separated by a whitespace
LOCAL_SRC_FILES  := ogles_introducing_pvr_api.cpp
