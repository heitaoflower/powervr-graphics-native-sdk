...
ASSETDIR := $(PVRSDKDIR)/examples/beginner/05_introducing_ui_renderer/vulkan/platform/android/assets
...
# Module vulkan_introducing_ui_renderer
include $(CLEAR_VARS)

LOCAL_MODULE    := vulkan_introducing_ui_renderer

### Add all source file names to be included in lib separated by a whitespace
LOCAL_SRC_FILES  := vulkan_introducing_ui_renderer.cpp
