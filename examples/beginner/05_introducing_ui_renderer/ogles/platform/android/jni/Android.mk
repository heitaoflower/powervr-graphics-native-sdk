...
ASSETDIR := $(PVRSDKDIR)/examples/beginner/05_introducing_ui_renderer/ogles/platform/android/assets
...
# Module ogles_introducing_ui_renderer
include $(CLEAR_VARS)

LOCAL_MODULE    := ogles_introducing_ui_renderer

### Add all source file names to be included in lib separated by a whitespace
LOCAL_SRC_FILES  := ogles_introducing_ui_renderer.cpp
